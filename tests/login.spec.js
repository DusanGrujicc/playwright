...
test.describe("log in",()=>{
 ...
 test("form text input should both have placeholder attribute", async ({page})=>{
...
test("form text input should both have placeholder values", async ({page})=>{
    const emailPlaceholder = "Email address"
    const passwordPlaceholder = "Password"
    await expect(loginPage.emailInput).toHaveAttribute("placeholder", emailPlaceholder)
    await expect(loginPage.passwordInput).toHaveAttribute("placeholder", passwordPlaceholder)

});
test("form text input should both have values when typed into", async ({page})=>{
